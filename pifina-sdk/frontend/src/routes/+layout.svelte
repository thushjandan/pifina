...
<nav class="bg-indigo-500">
      ...
      <div class="flex flex-grow items-center justify-end sm:items-stretch">
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            <a href="/config" class="text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Configuration</a>
            <a href="/about" class="text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">About</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="sm:hidden" id="mobile-menu">
    <div class="space-y-1 px-2 pb-3 pt-2">
      <!-- Current: "bg-indigo-900 text-white", Default: "text-indigo-300 hover:bg-indigo-700 hover:text-white" -->
      <a href="/" class="bg-indigo-900 text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page">Dashboard</a>
      <a href="/config" class="text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page">Configuration</a>
      <a href="/about" class="text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page">About</a>
    </div>
  </div>
</nav>

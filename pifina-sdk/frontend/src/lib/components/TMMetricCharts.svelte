    ...
    <div bind:clientWidth={clientHalfScreenWidth} class="mt-8 pt-4">
        <div class="grid grid-cols-4">
            ...
            <div class="sm:col-span-3 justify-self-end">
                <button on:click={() => openDetailView(PROBE_INGRESS_MATCH_CNT_BYTE, "(bytes/sec)")} class="bg-indigo-600 hover:bg-indigo-800 text-white text-center font-medium rounded-lg text-sm w-full sm:w-auto px-3 py-2.5 mr-2">

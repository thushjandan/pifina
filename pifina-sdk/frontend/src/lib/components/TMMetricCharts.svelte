...
<div class="mt-8 grid md:grid-cols-2">
    ...
    <div bind:clientWidth={clientHalfScreenWidth} class="mt-8 pt-4">
        <h2>Ingress packet drops from TM perspective</h2>
        <Chart options={{
            x: xScaleOptions,
            y: {
                label: "pkts",
            ...
            marks: [
                ...
                Plot.tip(metricData[PROBE_TM_INGRESS_DROP_PKT], Plot.pointerX({x: "timestamp", y: "value", channels: {sessionId: "sessionId"}})),
            ]
        }} />
    </div>
    <div bind:clientWidth={clientHalfScreenWidth} class="mt-8 pt-4">
        <h2>Egress packet drops from TM perspective</h2>
        <Chart options={{
            x: xScaleOptions,
            y: {
                label: "pkts",
            ...
            marks: [
                ...
                Plot.tip(metricData[PROBE_TM_EGRESS_DROP_PKT], Plot.pointerX({x: "timestamp", y: "value", channels: {sessionId: "sessionId"}})),
            ]
        }} />
    </div>
    <div bind:clientWidth={clientHalfScreenWidth} class="mt-8 pt-4">
        <h2>Port usage count in terms of number of memory cells usage from TM ingress perspective</h2>
        <Chart options={{
            x: xScaleOptions,
            y: {
                label: "pkts",
            ...
            marks: [
                ...
                Plot.tip(metricData[PROBE_TM_INRESS_USAGE_CELLS], Plot.pointerX({x: "timestamp", y: "value", channels: {sessionId: "sessionId"}})),
            ]
        }} />
    </div>
    <div bind:clientWidth={clientHalfScreenWidth} class="mt-8 pt-4">
        <h2>Port usage count in terms of number of memory cells usage from TM egress perspective</h2>
        <Chart options={{
            x: xScaleOptions,
            y: {
                label: "pkts",
            ...
            marks: [
                ...
                Plot.tip(metricData[PROBE_TM_ERESS_USAGE_CELLS], Plot.pointerX({x: "timestamp", y: "value", channels: {sessionId: "sessionId"}})),
            ]
        }} />
    </div>
    {/if}
